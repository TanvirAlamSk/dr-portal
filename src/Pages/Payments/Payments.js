...
const Payments = () => {
    ...
    const { appointmentDate, email, name, patientName, phoneNo, timeSlot } = data
    return (
        <div>
            <div className="py-12 transition duration-150 ease-in-out z-10" id="modal">
                <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                        ...
                        <h1 className="text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4">Please Pay for Your Appointment On <span className='text-secondary'>{name}</span></h1>
                        <label htmlFor="name" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">
                            Patient Name
                        </label>
                        <input id="name" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder={`${patientName}`} disabled />
                        ...
                        <div className="relative mb-5 mt-2">
                            ...
                            <input id="expiry" className="text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder={`${appointmentDate}`} readOnly />
                        </div>
                        ...
                        <div className="relative mb-5 mt-2">
                            ...
                            <input id="cvc" className="mb-8 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder={`${timeSlot}`} disabled />
                        </div>
                        <div className="flex items-center justify-start w-full">
                            <button className="focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm">Payment</button>
